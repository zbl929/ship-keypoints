...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=r'D:\CV_project\mmpose-main\configs\body_2d_keypoint\rtmpose\body8\rtmpose-m_8xb256-420e_body8-256x192.py',
    ...
    parser.add_argument(
        '--pose_lifter_config',default=r'D:\CV_project\mmpose-main\configs\body_3d_keypoint\video_pose_lift\h36m\video-pose-lift_tcn-243frm-supv-cpn-ft_8xb128-200e_h36m.py',
        help='Config file for the 2nd stage pose lifter model')
    parser.add_argument(
        '--pose_lifter_checkpoint',default='https://download.openmmlab.com/mmpose/body3d/videopose/videopose_h36m_243frames_fullconv_supervised_cpn_ft-88f5abbb_20210527.pth ',
        help='Checkpoint file for the 2nd stage pose lifter model')
    parser.add_argument('--input', type=str, default='https://user-images.githubusercontent.com/87690686/164970135-b14e424c-765a-4180-9bc8-fa8d6abc5510.mp4', help='Video path')
    parser.add_argument(
        '--show',
        action='store_true',
        default=False,
