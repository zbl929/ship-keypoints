...
def parse_args():
    ...
    parser.add_argument(
        '--inputs',
        type=str,
        default=r'D:\CV_project\mmpose-main\tools\logs',
        nargs='?',
        help='Input image/video path or folder path.')
    parser.add_argument(
        '--pose2d',
        type=str,
        default=r'D:\CV_project\mmpose-main\tools\logs\ship_keypoint.py',
        help='Pretrained 2D pose estimation algorithm. It\'s the path to the '
        'config file or the model name defined in metafile.')
    parser.add_argument(
        '--pose2d-weights',
        type=str,
        default=r'D:\CV_project\mmpose-main\tools\logs\best_coco_AP_epoch_40.pth',
