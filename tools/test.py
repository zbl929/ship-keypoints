...
def parse_args():
    ...
    parser.add_argument('--config',default=r'D:\CV_project\mmpose-main\tools\logs\ship_keypoint.py', help='test config file path')
    parser.add_argument('--checkpoint',default=r'D:\CV_project\mmpose-main\tools\logs\best_coco_AP_epoch_40.pth', help='checkpoint file')
    parser.add_argument(
    ...
    parser.add_argument(
        '--show-dir',default=r'D:\CV_project\mmpose-main\tools\logs',
