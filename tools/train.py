...
def parse_args():
    ...
    parser.add_argument('--config', default=r'D:\CV_project\mmpose-main\configs\body_2d_keypoint\rtmpose\coco\ship_keypoint.py', help='train config file path')
    parser.add_argument('--work-dir', default=r'D:\CV_project\mmpose-main\tools\logs',help='the dir to save logs and models')
    parser.add_argument(
        '--resume',
        nargs='?',
        type=str,
